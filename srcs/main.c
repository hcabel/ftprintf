...
int		main(int argc, char **argv)
{
	...
	else if (argc == 1)
	{
		...
		printf("02) Vrai PRINTF : |%.8%|\n");
		ft_printf("02) Mon PRINTF  : |%.8%|\n");
		printf("03) Vrai PRINTF : |%.%|\n");
		ft_printf("03) Mon PRINTF  : |%.%|\n");
		printf("04) Vrai PRINTF : |%#%|\n");
		ft_printf("04) Mon PRINTF  : |%#%|\n");
		printf("05) Vrai PRINTF : |%+%|\n");
		ft_printf("05) Mon PRINTF  : |%+%|\n");
		printf("06) Vrai PRINTF : |%-%|\n");
		ft_printf("06) Mon PRINTF  : |%-%|\n");
		printf("07) Vrai PRINTF : |%10%|\n");
		ft_printf("07) Mon PRINTF  : |%10%|\n");
		printf("08) Vrai PRINTF : |%-10%|\n");
	...
	{
		ft_printf("--------------------%%ret------------------\n");
		printf(" |%d|\n", printf("01) Vrai PRINTF : |%hhX|", (unsigned char)34));
		printf(" |%d|\n", ft_printf("01) Mon PRINTF  : |%hhX|", (unsigned char)34));
		printf(" |%d|\n", printf("02) Vrai PRINTF : |%hhX|", (unsigned char)-34));
		printf(" |%d|\n", ft_printf("02) Mon PRINTF  : |%hhX|", (unsigned char)-34));
		printf(" |%d|\n", printf("03) Vrai PRINTF : |%-hhX|", (unsigned char)50));
		printf(" |%d|\n", ft_printf("03) Mon PRINTF  : |%-hhX|", (unsigned char)50));
		printf(" |%d|\n", printf("04) Vrai PRINTF : |%10hhX|", (unsigned char)90));
		printf(" |%d|\n", ft_printf("04) Mon PRINTF  : |%10hhX|", (unsigned char)90));
		printf(" |%d|\n", printf("05) Vrai PRINTF : |%.10hhX|", (unsigned char)90));
		printf(" |%d|\n", ft_printf("05) Mon PRINTF  : |%.10hhX|", (unsigned char)90));
		printf(" |%d|\n", printf("06) Vrai PRINTF : |%15hhX|", (unsigned char)-100));
		printf(" |%d|\n", ft_printf("06) Mon PRINTF  : |%15hhX|", (unsigned char)-100));
		printf(" |%d|\n", printf("07) Vrai PRINTF : |%.15hhX|", (unsigned char)-100));
		printf(" |%d|\n", ft_printf("07) Mon PRINTF  : |%.15hhX|", (unsigned char)-100));
		printf(" |%d|\n", printf("08) Vrai PRINTF : |%10.5hhX|", (unsigned char)52));
		printf(" |%d|\n", ft_printf("08) Mon PRINTF  : |%10.5hhX|", (unsigned char)52));
		printf(" |%d|\n", printf("09) Vrai PRINTF : |%5.10hhX|", (unsigned char)52));
		printf(" |%d|\n", ft_printf("09) Mon PRINTF  : |%5.10hhX|", (unsigned char)52));
		printf(" |%d|\n", printf("10) Vrai PRINTF : |%20.15hhX|", (unsigned char)-10000));
		printf(" |%d|\n", ft_printf("10) Mon PRINTF  : |%20.15hhX|", (unsigned char)-10000));
		printf(" |%d|\n", printf("11) Vrai PRINTF : |%15.20hhX|", (unsigned char)-10000));
		printf(" |%d|\n", ft_printf("11) Mon PRINTF  : |%15.20hhX|", (unsigned char)-10000));
		printf(" |%d|\n", printf("12) Vrai PRINTF : |%-10hhX|", (unsigned char)144));
		printf(" |%d|\n", ft_printf("12) Mon PRINTF  : |%-10hhX|", (unsigned char)144));
		printf(" |%d|\n", printf("13) Vrai PRINTF : |%-.10hhX|", (unsigned char)144));
		printf(" |%d|\n", ft_printf("13) Mon PRINTF  : |%-.10hhX|", (unsigned char)144));
		printf(" |%d|\n", printf("14) Vrai PRINTF : |%-20hhX|", (unsigned char)-20000));
		printf(" |%d|\n", ft_printf("14) Mon PRINTF  : |%-20hhX|", (unsigned char)-20000));
		printf(" |%d|\n", printf("15) Vrai PRINTF : |%08hhX|", (unsigned char)64));
		printf(" |%d|\n", ft_printf("15) Mon PRINTF  : |%08hhX|", (unsigned char)64));
		printf(" |%d|\n", printf("16) Vrai PRINTF : |%03.4hhX|", (unsigned char)10));
		printf(" |%d|\n", ft_printf("16) Mon PRINTF  : |%03.4hhX|", (unsigned char)10));
		printf(" |%d|\n", printf("17) Vrai PRINTF : |%#hhX|", (unsigned char)34));
		printf(" |%d|\n", ft_printf("17) Mon PRINTF  : |%#hhX|", (unsigned char)34));
		printf(" |%d|\n", printf("18) Vrai PRINTF : |%#.5hhX|", (unsigned char)34));
		printf(" |%d|\n", ft_printf("18) Mon PRINTF  : |%#.5hhX|", (unsigned char)34));
		printf(" |%d|\n", printf("19) Vrai PRINTF : |%#5hhX|", (unsigned char)86));
		printf(" |%d|\n", ft_printf("19) Mon PRINTF  : |%#5hhX|", (unsigned char)86));
		printf(" |%d|\n", printf("20) Vrai PRINTF : |%#10.5hhX|", (unsigned char)70));
		printf(" |%d|\n", ft_printf("20) Mon PRINTF  : |%#10.5hhX|", (unsigned char)70));
		printf(" |%d|\n", printf("21) Vrai PRINTF : |%#hhX|", (unsigned char)0));
		printf(" |%d|\n", ft_printf("21) Mon PRINTF  : |%#hhX|", (unsigned char)0));
		printf(" |%d|\n", printf("22) Vrai PRINTF : |%#.hhX|", (unsigned char)0));
		printf(" |%d|\n", ft_printf("22) Mon PRINTF  : |%#.hhX|", (unsigned char)0));
		printf(" |%d|\n", printf("23) Vrai PRINTF : |%.hhX|", (unsigned char)0));
		printf(" |%d|\n", ft_printf("23) Mon PRINTF  : |%.hhX|", (unsigned char)0));
		printf(" |%d|\n", printf("24) Vrai PRINTF : |%.hhX|", (unsigned char)88));
		printf(" |%d|\n", ft_printf("24) Mon PRINTF  : |%.hhX|", (unsigned char)88));
		printf(" |%d|\n", printf("25) Vrai PRINTF : |%#.hhX|", (unsigned char)88));
		printf(" |%d|\n", ft_printf("25) Mon PRINTF  : |%#.hhX|", (unsigned char)88));
		printf(" |%d|\n", printf("26) Vrai PRINTF : |%hhX|", (unsigned char)255));
		printf(" |%d|\n", ft_printf("26) Mon PRINTF  : |%hhX|", (unsigned char)255));
		printf(" |%d|\n", printf("27) Vrai PRINTF : |%#hhX|", (unsigned char)255));
		printf(" |%d|\n", ft_printf("27) Mon PRINTF  : |%#hhX|", (unsigned char)255));
		printf(" |%d|\n", printf("28) Vrai PRINTF : |%#hhX| |%#hhX|", (unsigned char)-1, (unsigned char)256));
		printf(" |%d|\n", ft_printf("28) Mon PRINTF  : |%#hhX| |%#hhX|", (unsigned char)-1, (unsigned char) 256));
		printf(" |%d|\n", printf("29) Vrai PRINTF : |hello ca%----4c %1c va %10c%-c ??|", '\0', '\n', (char)564, 0));
		printf(" |%d|\n", ft_printf("29) Mon PRINTF  : |hello ca%----4c %1c va %10c%-c ??|", '\0', '\n', (char)564, 0));
	}
	else
		ft_putstr("./printf [c, s, p, d/i, hd/hi, hhd/hhi, ld/li, lld,lli, o, ho, hho, lo, llo, x, hx, hhx, lx, llx, X, hX, hhX, lX, llu, u, hu, hhu, lX, llu]\n");
	return (0);
